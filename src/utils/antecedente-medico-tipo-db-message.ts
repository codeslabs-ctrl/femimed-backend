...
export function friendlyAntecedenteMedicoTipoMessage(err: unknown): string | undefined {
  ...
  switch (pg.code) {
    ...
    case '23503':
      ...
      return undefined;
    case '23505':
      if (pg.constraint === 'antecedente_medico_tipo_tipo_nombre_key') {
        return 'Ya existe un antecedente con ese nombre en la misma categoría. Use otro nombre o edite el existente.';
      }
      return undefined;
    default:
      return undefined;
